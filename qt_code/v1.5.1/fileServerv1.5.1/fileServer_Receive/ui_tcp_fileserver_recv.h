...
public:
    ...
    void setupUi(QMainWindow *Tcp_FileServer_Recv)
    {
        ...
        serverStatusLabel->setGeometry(QRect(30, 10, 81, 21));
        startButton = new QPushButton(centralWidget);
        startButton->setObjectName(QString::fromUtf8("startButton"));
        startButton->setGeometry(QRect(330, 10, 51, 31));
        quitButton = new QPushButton(centralWidget);
        quitButton->setObjectName(QString::fromUtf8("quitButton"));
        quitButton->setGeometry(QRect(460, 10, 51, 31));
        clientProgressBar = new QProgressBar(centralWidget);
        clientProgressBar->setObjectName(QString::fromUtf8("clientProgressBar"));
        clientProgressBar->setGeometry(QRect(660, 10, 101, 23));
        ...
        serverProgressBar->setGeometry(QRect(520, 10, 131, 23));
        ...
        stopButton->setGeometry(QRect(390, 10, 61, 31));
