...
QString tcpClientFileSend::ReadIpAddr()
{
    ...
    if(file.exists())
    {
        ...
        file.close();
//        qDebug() << "lineedithost:" << ui->lineEditHost->text();
//        qDebug() << "dataFromFile:" << dataFromFile;
//        if((dataFromFile !=ui->lineEditHost->text())
//                &&(!ui->lineEditHost->text().isEmpty()))
//        {
//            file.open(QIODevice::WriteOnly);
//            file.write(ui->lineEditHost->text().toLocal8Bit());
//            file.close();
//        }
